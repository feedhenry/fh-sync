...
var ConsoleLogger = require("./consolelogger").ConsoleLogger;
var logger;
...
var self = {
  ...
  createDataset: function (dataset_id, options, cb) {
    ...
    syncUtil.setLogger(dataset_id, logger);
...
var init = function(config) {
  ...
  if (!config || !config.logger) {
    logger = new ConsoleLogger(baselogger.LEVEL_COMPAT[self.defaults.logLevel]);
  }

  syncUtil.setLogger(syncUtil.SYNC_LOGGER, logger);
