...
//TODO: move this to the mongodb-queue module and use the `insertMany` function
MongodbQueue.prototype.addMany = function(messages, cb) {
  var self = this;
  async.eachLimit(messages, self.addConcurrency, async.apply(self.add.bind(self)), cb);
};
